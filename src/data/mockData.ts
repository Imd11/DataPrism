...
export const mockTables: DataTable[] = [
  {
    ...
    name: 'companies',
    fields: [
      { name: 'company_id', type: 'string', nullable: false },
      { name: 'company_name', type: 'string', nullable: false },
      { name: 'industry', type: 'string', nullable: true, missingCount: 5, missingRate: 0.02 },
      { name: 'founded_year', type: 'number', nullable: true, missingCount: 12, missingRate: 0.05 },
      { name: 'employees', type: 'number', nullable: true, missingCount: 8, missingRate: 0.03 },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'revenue', type: 'number', nullable: true, missingCount: 15, missingRate: 0.03 },
      { name: 'profit', type: 'number', nullable: true, missingCount: 22, missingRate: 0.04 },
      { name: 'assets', type: 'number', nullable: true, missingCount: 8, missingRate: 0.02 },
      { name: 'liabilities', type: 'number', nullable: true, missingCount: 8, missingRate: 0.02 },
    ],
    rowCount: 500,
    sourceType: 'imported',
    dirty: true,
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'email', type: 'string', nullable: true, missingCount: 45, missingRate: 0.09 },
